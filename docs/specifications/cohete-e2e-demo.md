...
See [components/binary-matrix.md](components/binary-matrix.md) for full details.
...
See [components/test-tiers.md](components/test-tiers.md) for test definitions.
...
See [components/artifacts.md](components/artifacts.md) for full schemas.
